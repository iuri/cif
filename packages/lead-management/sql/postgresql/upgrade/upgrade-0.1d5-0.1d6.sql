-- /packages/lead-management/sql/postgresql/upgrade/upgrade-0.1d5-0.1d6.sql

SELECT acs_log__debug ('/packages/lead-management/sql/postgresql/upgrade/upgrade-0.1d5-0.1d6.sql', '');
