...
CREATE OR REPLACE FUNCTION lm_lead_contact__new (integer, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar)
RETURNS integer AS '
DECLARE
