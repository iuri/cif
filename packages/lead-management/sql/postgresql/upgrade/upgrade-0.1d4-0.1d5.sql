-- /packages/lead-management/sql/postgresql/upgrade/upgrade-0.1d4-0.1d5.sql

SELECT acs_log__debug ('/packages/lead-management/sql/postgresql/upgrade/upgrade-0.1d4-0.1d5.sql', '');


DROP FUNCTION lm_lead_contact__new (integer, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar);
